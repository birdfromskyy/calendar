        ...
        content: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text('Выбрать дату выполнения'),
            ),
          ],
        ),
        actions: [
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (pickedDate != null) {
                  setState(() {
                    widget.tasks[index]['date'] = pickedDate.toIso8601String();
                  });
                  widget.onUpdate(widget.tasks);
                }
              },
        ...
        itemBuilder: (context, index) {
          return ListTile(
            ...
            subtitle: widget.tasks[index]['date'] != null
                ? Text(
                    'Дата выполнения: ${DateFormat('dd.MM.yyyy').format(DateTime.parse(widget.tasks[index]['date']))}')
                : Text('Без даты'),
